...
export type ColumnOptions = {
    colors: ApplyFields<
        Collections.TicketsStatuses,
        ['id', 'color', 'name', 'order']
    >[]
    priorities: ApplyFields<
        Collections.TicketsPriorities,
        ['id', 'color', 'name', 'level']
    >[]
    types: ApplyFields<
        Collections.TicketsTypes,
        ['id', 'name', 'icon', 'level', 'description']
    >[]
}
        ...
        <TooltipProvider>
            <Tooltip>
                <TooltipTrigger asChild>
                    <div className="text-muted-foreground hover:text-primary flex cursor-pointer items-center gap-1 text-xs transition-colors">
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                if (!priorityObj && priorityId && options?.priorities) {
                    priorityObj = options.priorities.find(
                        (p) => p.id === priorityId
                    )
                }
